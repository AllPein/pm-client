...
import { fetchProjects, fetchAllProjects } from "@/actions/projects";
  ...
  const renderProjects = useMemo(() => {
    ...
    return (
      <Empty
        ...
        description={<span>Проектов нет :(</span>}
      />
    );
    ...
    () => (
      <>
        ...
        <Input.TextArea
          ...
          placeholder="Заполните поле"
        />
        <UI.FieldName>Дата сдачи</UI.FieldName>
        <DatePicker onChange={onChangeDate} locale={locale} />
        <UI.FieldName>Аватар</UI.FieldName>
        <Upload
